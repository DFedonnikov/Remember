...
public class MainLocalDataSource implements MemoLocalDataSource {

    Realm primaryRealm;
    Realm secondaryRealm;

    public MainLocalDataSource(Realm primaryRealm, Realm secondaryRealm) {
        this.primaryRealm = primaryRealm;
        this.secondaryRealm = secondaryRealm;
    }
